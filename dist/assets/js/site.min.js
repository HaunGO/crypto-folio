...
var masterWallet = new __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__["a" /* default */]({
    ...
    data: function data() {
        return {
            wallet: "wallet",
            apies: ["https://api.coinmarketcap.com/v1/ticker/", "https://api.coinmarketcap.com/v1/ticker/dent/", "https://api.coinmarketcap.com/v1/ticker/pillar/", "https://api.coinmarketcap.com/v1/ticker/veritaseum/", "https://api.coinmarketcap.com/v1/ticker/substratum/"],
...
__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__["a" /* default */].component('wallet', {
    ...
    methods: {
        buildWallet: function buildWallet() {
            ...
            this.thisWallet = this.mixinBuildWallet(useThis, this.$store.getters.allCoins);
