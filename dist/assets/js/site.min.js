...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__component_masterWallet_js__ = __webpack_require__(/*! ./component-masterWallet.js */ "t4Uj");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__component_coinbox_js__ = __webpack_require__(/*! ./component-coinbox.js */ "hCcw");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__component_coin_js__ = __webpack_require__(/*! ./component-coin.js */ "hor5");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__component_chart_js__ = __webpack_require__(/*! ./component-chart.js */ "NEop");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__component_totals_js__ = __webpack_require__(/*! ./component-totals.js */ "Xrcg");
...
var folio = new __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__["a" /* default */]({
    el: '#myCryptoFolio',
    delimiters: ['${', '}'],
    ...
    methods: {
        ...
        addLogos: function addLogos() {
            var self = this;
            console.log('addLogos() ', self.$root.totalHoldings);
            var list = [];

            for (var coin in self.$root.totalHoldings) {
                // console.log(coin);
                list.push(coin);
            ...
            self.CMC.getMetadata({ symbol: list }).then(function (response) {
                ...
                for (var each in obj) {
                    ...
                    var logoUrl = obj[each].logo;
                    var thisCoin = self.filterCoin(obj[each].symbol);
        ...
        fetchData2: function fetchData2() {
            ...
            this.CMC.getTickers({ limit: 100 }).then(function (response) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__myCryptoFolio_js__ = __webpack_require__(/*! ./myCryptoFolio.js */ "2aJS");
...
var myMixin = {
    ...
    methods: {
        ...
        mixinPrebuildWallet: function mixinPrebuildWallet(_myCoins) {
        ...
        mixinBuildWalletV2: function mixinBuildWalletV2(_myCoins, _allCoins) {
            ...
            for (var thing in _myCoins) {
                ...
                if (thisCoin == undefined) {
                    ...
                    var thisHolding = '' + _myCoins[thing];
                    var thisHoldingValue = '' + _myCoins[thing];
                    var thisLogoUrl = self.$root.allMyCoinsMeta['' + thing].logo;
...
__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__["a" /* default */].component('chart', {
    ...
    methods: {
        setupEvents: function setupEvents() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__eventBus_js__["a" /* default */].$on('wallet-prebuilt-' + this.$parent._uid, this.prebuildChart);

            __WEBPACK_IMPORTED_MODULE_1__eventBus_js__["a" /* default */].$on('wallet-built-' + this.$parent._uid, this.buildChart);
        },

        prebuildChart: function prebuildChart(_thisWallet_) {
...
__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__["a" /* default */].component('wallet', {
    ...
    methods: {
        prebuildWallet: function prebuildWallet(thisHolding) {
            ...
            if (thisHolding != null) {
                ...
                __WEBPACK_IMPORTED_MODULE_1__eventBus_js__["a" /* default */].$emit('wallet-prebuilt-' + this._uid, this.thisWallet);
            }
        },
        buildWallet: function buildWallet() {
...
__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__["a" /* default */].component('coinbox', {
    ...
    methods: {
        setupEvents: function setupEvents() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__eventBus_js__["a" /* default */].$on('wallet-prebuilt-' + this.$parent._uid, function (w) {
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
  ...
  mutations: {
    ...
    //?
    addAllMyCoins: function addAllMyCoins(state, coin) {
  ...
  getters: {
    ...
    //?
    allMyCoins: function allMyCoins(state) {
...
/***/ "t4Uj":
/*!******************************************!*\
  !*** ./src/js/component-masterWallet.js ***!
  \******************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__["a" /* default */].component('masterwallet', {
    mixins: [__WEBPACK_IMPORTED_MODULE_2__mixins_js__["a" /* default */]],
    data: function data() {
        return {
            myHoldingsTotalInUSD: 0,
