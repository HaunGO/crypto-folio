...
var vues = document.querySelectorAll(".wallet");

var eachVue = Array.prototype.forEach;

eachVue.call(vues, function (el, index) {
    new Vue({
        ...
        methods: {
            ...
            fetchData: function fetchData() {
                ...
                Promise.all(promises).then(function (d) {
                    ...
                    document.title = _this.formatAsUSD(_this.myHoldingsTotalInUSD);
                }).catch(function (e) {
            ...
            buildMyWallet: function buildMyWallet(coins) {
                ...
                return coins.filter(function (coin) {
                    ...
                    return Object.keys(_this2.myHoldings).indexOf(coin.symbol) >= 0;
                }).map(function (c) {
                    return Object.assign({}, c, {
                        holding: _this2.myHoldings[c.symbol],
                        holding_value: c.price_usd * _this2.myHoldings[c.symbol]
                    });
                }).sort(function (a, b) {
