...
new Vue({
    ...
    data: {
        apies: ["https://api.coinmarketcap.com/v1/ticker/"],
        allCoins: [],
        myHoldings: {
            // "BCH": 1,
            // "BTC": 2,
        ...
        favorites: [{ name: 'Litecoin', symbol: 'LTC', icon: 'link/to/graphic', color: 'red' }, { name: 'Ethereum', symbol: 'ETH', icon: 'link/to/graphic', color: 'green' }, { name: 'EOS.io', symbol: 'EOS', icon: 'link/to/graphic', color: 'blue' }]
    ...
    methods: {
        ...
        totalUSD: function totalUSD() {
            ...
            this.myWallet.reduce(function (total, c) {
